...
const updatePilgrimExperience = async (req, res) => {
  try {
    ...
    const updateFields = {
      ...
      numberOfDays: numberOfDays !== undefined ? numberOfDays : experience.numberOfDays,
      numberOfNights: numberOfNights !== undefined ? numberOfNights : experience.numberOfNights,
