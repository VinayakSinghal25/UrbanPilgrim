...
const BookingReview = () => {
  ...
  useEffect(() => {
    console.log('BookingReview auth check:', { user: !!user, token: !!token }); // Debug log
  ...
  const handleCreateBooking = async () => {
    ...
    console.log('About to create booking with token:', token ? 'Present' : 'Missing');
    ...
    try {
      ...
      if (err.message === 'Invalid token' || err.message === 'No token, authorization denied') {
