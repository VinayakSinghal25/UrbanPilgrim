...
const WellnessGuideClassBooking = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ touchAction: 'auto', overflowY: 'auto' }}>
      {/* Sticky Booking Summary Header */}
      <div className="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-sm" style={{ touchAction: 'auto' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 sticky top-20" style={{ touchAction: 'auto' }}>
              {/* Class Image */}
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6" style={{ touchAction: 'auto', overflowY: 'visible' }}>
