// src/components/Profile/WellnessGuideProfile.jsx
...
export default function WellnessGuideProfile() {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const nameParts = accountDetails.name.trim().split(' ');
  ...
  // Handle navigation to wellness guide dashboard
  const handleGoToWellnessGuideDashboard = () => {
      ...
      <div className="bg-gradient-to-r from-slate-800 via-purple-600 to-red-500 px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            {/* Greeting and Wellness Guide Button */}
            <div className="text-center sm:text-left flex-1">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">
                Hi, {accountDetails.name || 'Wellness Guide'}
              </h1>
              
              {/* Wellness Guide Dashboard Button */}
              <button
                onClick={handleGoToWellnessGuideDashboard}
                className="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-white bg-opacity-20 hover:bg-opacity-30 text-black font-semibold rounded-lg ..."
              >
